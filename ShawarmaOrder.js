...
module.exports = class ShwarmaOrder extends Order{
    ...
    renderForm(sTitle = "-1", sAmount = "-1"){
      ...
      const sClientID = process.env.AbUDOdmeE2eoiSGLZPQ8OoAwj93NXw5kCJTXMlcal-rI6KEOJEYIuHHiMo_CcljKDfCQ91oAULH3pdEc || 'put your client id here for testing ... Make sure that you delete it before committing'
      return(`
      <!DOCTYPE html>
